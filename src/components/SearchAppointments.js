             ...
             <div className="input-group-append">
               ...
               <div className="sort-menu dropdown-menu dropdown-menu-right">
                 <button 
                  ...
                  onClick={e => {this.props.changeOrder('petName',this.orderDir)}}
                  href="#">
                   Pet Name
                 </button>
                 <button 
                  className={'sort-by dropdown-item ' + (this.props.orderBy === "aptDate" ? "active" : "")}
                  onClick={e => {this.props.changeOrder('aptDate',this.orderDir)}}
                  href="#">
                   Date
                 </button>
                 <button 
                  className={'sort-by dropdown-item ' + (this.props.orderBy === "ownerName" ? "active" : "")} 
                  onClick={e => {this.props.changeOrder('ownerName',this.orderDir)}}
                  href="#">
                   Owner
                 </button>
